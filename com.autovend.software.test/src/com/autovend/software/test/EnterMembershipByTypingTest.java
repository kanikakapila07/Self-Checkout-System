...
Muhtadi Alam- 30150910 
*/ 
public class EnterMembershipByTypingTest {
	
	String number;
	SelfCheckoutSystemLogic system;
	SelfCheckoutStation station;
	EnterMembershipByTyping membership;
	DoItYourselfStation gui;
	...
	public void setUp() throws Exception {
		...
		membership = new EnterMembershipByTyping(system, station);
		
		gui = new DoItYourselfStation(system, stationId);
	}
	...
	public void test() {
		...
		membership.enterMembershipByTyping(number);
		
		MembershipCard someCard = new MembershipCard("membership", number, "User", true);
		this.system.setCardSwipe(someCard, number);
		
		DoItYourselfStation.WelcomeScene welcomeScene = gui.new WelcomeScene(null);
		
		
		assertTrue(welcomeScene.membershipButton.isEnabled());
