...
public class PurchaseBagsTest extends BaseTestCase {
	...
	public void notEnoughBags() throws Exception {
		...
		this.system.setNumberBagsPurchased(101);
		...
		System.out.println(system.getBagDispenser().getCapacity());
		
		// let's try to purchase 50 bags, should be fine as there are 100 available
		this.system.setNumberBagsPurchased(50);
	...
	public void incorrectWeight() throws OverloadException, EmptyException {
		// let's generate a new bag product for our database, with an updated weight
		BarcodedProduct productBag = new BarcodedProduct(PurchaseBagsController.PURCHASEDBAGBARCODE, "Purchased bag", 
				PurchaseBagsController.PURCHASED_BAG_PRICE, 1000f);
		...
		this.system.setNumberBagsPurchased(5);
		this.system.setAttendantDisapproval(false);
	...
	public void billListUpdated() throws Exception {
		...
		this.system.setNumberBagsPurchased(25);
		system.purchaseBags();
		...
		this.system.setNumberBagsPurchased(57);
		system.purchaseBags();
